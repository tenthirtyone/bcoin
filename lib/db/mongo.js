...
const Models   = require('bcoin-mongo-models')(mongoose);
...
const WalletAddress = Models.WalletAddress;
...
mongoDB.prototype.getWalletAddresses = function getWalletAddresses() {
    return WalletAddress.getWalletAddresses();
};
