...
const TestCoin       = require('./models/testcoin');
...
mongoDB.prototype.saveTestCoins = function saveTestCoins(blockHash, coins) {
  return TestCoin.saveTestCoins(blockHash, coins);
};
